...
Once the `conda-forge` channel has been enabled, `keras-tuner` can be installed with:

```
conda install keras-tuner
```

It is possible to list all of the versions of `keras-tuner` available on your platform with:
